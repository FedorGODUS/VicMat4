...
import approximation.ApproximateFunction;
import point.Point;
...
public class GraphBuilder {
    ...
    public static void addRedPoint(Point point, XYChart chart) {
    ...
    public static void addFunctionToGraph(ApproximateFunction chosenApproximateFunction, ArrayList<Point> points, XYChart chart) {
        ArrayList<ArrayList<Double>> split = excludePoints(points);
        ArrayList<Double> xp = split.get(0);
    ...
    public static XYChart createFunctionGraphWithPoints(ApproximateFunction chosenApproximateFunction, ArrayList<Point> points) {
        ArrayList<ArrayList<Double>> split = excludePoints(points);
        ArrayList<Double> xp = split.get(0);
        ArrayList<Double> yp = split.get(1);
